...
return new class extends TestCase {
    public function testOnlyRunsWhen8c1bb8d0IsNot2() {
        $this->shouldReadSymbolOffset('_var_demoOrGameplayState_8c1bb8d0', 0, 2);
    ...
    public function testA() {
        $this->shouldReadSymbolOffset('_var_demoOrGameplayState_8c1bb8d0', 0, 1);

        $tasksPtr = $this->alloc(8 * 4 * 16);
        $this->rellocate('_tasks_8c1ba5e8', $tasksPtr);
