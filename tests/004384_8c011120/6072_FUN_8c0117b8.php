...
return new class extends TestCase {
    public function test_paramIs1()
    {
        ...
        $this->shouldWriteTo('_var_8c157aac', 0xbebacafe);
        $this->shouldWriteTo('_var_8c157ab4', 0xbebacafe + 8);

        $this->call('_FUN_8c0117b8')
            ->with(1)
            ->shouldReturn(1)
            ->run();
    }
    ...
    public function test_paramIs2()
    {
        ...
        $this->shouldWriteTo('_var_8c157aac', 0xbebacafe);
        $this->shouldWriteTo('_var_8c157ab4', 0xbebacafe + 16);
    ...
    public function test_returnsZeroOnFailedAllocation()
    {
        ...
        $this->shouldWriteTo('_var_8c157aac', 0);
    ...
    {
        $this->shouldWriteTo('_var_8c157ab4', -1);
        $this->shouldWriteTo('_var_8c157aac', -1);
