...
void FUN_8c016bf4()
{
    ...
    if (var_8c1bbc84 >= 1) {
        ...
        if (temp < &var_8c225fa8_2) {
            ...
            peripheral_8c1ba35c[0].on = (int) &temp;

            // var_8c1ba36c = var_8c1ba364 & (_var_8c225fac ^ var_8c1ba364);
            peripheral_8c1ba35c[0].press = peripheral_8c1ba35c[0].on & (var_8c225fac ^ peripheral_8c1ba35c[0].on);

            // var_8c1ba378 = (short)*(char *)(_var_8c225fa8 + 1);
            peripheral_8c1ba35c[0].x2 = var_8c225fa8->field_0x04;

            // var_8c1ba374 = (ushort)*(byte *)((int)_var_8c225fa8 + 5);
            peripheral_8c1ba35c[0].x1 = var_8c225fa8->field_0x05;

            // var_8c1ba376 = (ushort)*(byte *)((int)_var_8c225fa8 + 6);
            peripheral_8c1ba35c[0].y1 = var_8c225fa8->field_0x06;

            // _var_8c225fa8 = _var_8c225fa8 + 2;
            var_8c225fa8++;

            // _var_8c225fac = var_8c1ba364;
            var_8c225fac = peripheral_8c1ba35c[0].on;
        }
    }
}
