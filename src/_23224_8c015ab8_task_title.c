...
extern void push_fadein_8c015b5c(Uint32 duration);
...
extern void push_fadeout_8c022b60(Uint32 duration);
void _8c02ae3e(Float32 a, Float32 b, Uint32 c, Uint32 d, Uint32 e);
...
void task_title_8c015ab8(Task *task, void *state) {
    ...
    PDS_PERIPHERAL *per = &per_8c1ba35c;

    if (menu_state_8c1bc7a8.state_0x18 >= TITLE_BUS_SLIDE && menu_state_8c1bc7a8.state_0x18 <= TITLE_FLAG_REVEAL && per->press & PDD_DGT_ST) {
    ...
    switch (menu_state_8c1bc7a8.state_0x18) {
        ...
        case TITLE_FORTYFIVE_FADEIN:
            ...
            drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 0, 0, 0, -5);
        ...
        case TITLE_ADX_FADEIN:
            ...
            drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 3, 0, 0, -5);
            break;
        ...
        case TITLE_VMU_WARN_FADEIN:
            ...
            drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 17, 0, 0, -5);
        ...
        case TITLE_VMU_WARN:
            if ((per->press & (PDD_DGT_ST | PDD_DGT_TA)) || _8c019550(s_TOKYOBUS_001_8c037f60, 3) != 0) {
                sdMidiPlay(midi_handle_8c0fcd28, 1, 0, 0);
        ...
        case TITLE_BUS_SLIDE:
            ...
            if (menu_state_8c1bc7a8.bus_x_pos_0x20 <= 180) {
                ...
                /* drawSprite_8c014f54(); */
                drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 1, menu_state_8c1bc7a8.bus_x_pos_0x20, 0, -4);
                drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 2, 0, 0, -5);
                drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 46, 0, 0, -7);
        ...
        case TITLE_0X0D:
            ...
            drawSprite_8c014f54(&menu_state_8c1bc7a8.drawdatstruct1_0x0c, 5, 0, 0, -4);
...
void _8c015fd6(Uint32 param1) {
    Uint32 local_param1 = param1;
    ...
    pushTask_8c014ae8((Task *) &_8c1ba3c8, (TaskAction) &task_8c012f44, &task, &state, 0);

    njSetBackColor(0x00000000, 0x00000000, 0x00000000);

    pushTask_8c014ae8((Task *) &_8c1ba3c8, (TaskAction) &task_title_8c015ab8, &task, &state, 0);

    menu_state_8c1bc7a8.state_0x18 = TITLE_INIT;
    menu_state_8c1bc7a8.field_0x64 = 0;

    task->field_0x08 = local_param1;

    njGarbageTexture((NJS_TEXMEMLIST *) &_8c157af8, 0xc00);
